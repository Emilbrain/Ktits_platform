...
@section('content')
        <div>
            ...
            <form id="quillForm" method="POST" action="{{ route('admin.edit.theory.section',  $theory->id) }}" enctype="multipart/form-data">
@csrf
                @method("PUT")
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div id="editor1" class="bg-white p-4 border rounded">{!! old('theory', $theory->theory) !!}</div>
