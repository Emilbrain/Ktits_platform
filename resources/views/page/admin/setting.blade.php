    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="bg-white rounded-xl px-5 pt-5 pb-4 flex flex-col">
            ...
            <div class="flex justify-center mb-4">
                @if(auth()->user()->logo)
                    <img src="{{ asset('storage/'  . auth()->user()->logo) }}" alt="Аватар" class="w-16">
                @else
                    <img src="{{ asset('images/user.png') }}" alt="Аватар по умолчанию" class="w-16">
                @endif
            </div>
            ...
            <form action="{{route('admin.setting.update.avatar')}}" method="post" enctype="multipart/form-data">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG или GIF (MAX. 800x400px).</p>
                <input type="submit"
                       class="bg-gray-900 mt-3 w-full sm:w-auto text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                       value="Сменить">
            </form>
        </div>
        ...
        <div class="bg-white rounded-xl px-5 pt-5 pb-4 flex flex-col justify-between relative">
            ...
            <form action="{{ route('admin.setting.update.password') }}" method="post">
                ...
                <input type="submit"
                       class="bg-gray-900 w-full sm:w-auto text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
