...
@section('content')
    <div class="flex gap-5 flex-col">
        <div class="bg-white rounded-xl px-5 pt-5 pb-4 flex flex-col">
            ...
            <form action="{{route('teacher.setting.update.avatar')}}" method="post" enctype="multipart/form-data">
                @csrf
                <input
...
{{--        </div>--}}
        <div class="bg-white rounded-xl px-5 pt-5 pb-4 flex flex-col justify-between relative">
            ...
            <form action="{{ route('teacher.setting.update.password') }}" method="post">
                @csrf
                ...
                <label for="new_password" class="block mt-3 mb-2 text-sm font-medium text-gray-900 dark:text-white">Новый пароль</label>
                ...
                <label for="new_password_confirmation" class="block mt-3 mb-2 text-sm font-medium text-gray-900 dark:text-white">Подтверждение пароля</label>
