...
<body>
<header class="bg-[#3F83F8] py-4 absolute top-0 z-40 w-full">
    <div class="container mx-auto px-4 flex items-center justify-between flex-wrap">
        <!-- Логотипы -->
        <div class="flex items-center space-x-2">
            <img src="{{asset('images/ckLogo.png')}}" alt="logo CK" class="h-10 sm:h-12">
            <img src="{{asset('images/ktitsLogo.png')}}" alt="logo ktits" class="h-10 sm:h-12">
        </div>

        <!-- Навигация -->
        <nav class="hidden lg:flex space-x-[30px] text-white text-sm">
            <a href="#" class="hover:underline">Навигация</a>
            <a href="#" class="hover:underline">Навигация</a>
            <a href="#" class="hover:underline">Навигация</a>
            <a href="#" class="hover:underline">Навигация</a>
        </nav>
        ...
        <div class="mt-3 sm:mt-0">
            @guest()
                <a href="{{route('login')}}"
                   class="bg-white inline-block text-[#3F83F8] font-medium rounded-lg px-6 py-2 text-sm md:px-[32px] md:py-[18px] hover:bg-gray-100 transition">Войти</a>
            @endguest
            @auth()
                <a href="{{route('login')}}"
                   class="bg-white inline-block text-[#3F83F8] font-medium rounded-lg px-6 py-2 text-sm md:px-[32px] md:py-[18px] hover:bg-gray-100 transition">Платформа</a>
            @endauth
        </div>
    </div>
</header>
...
<section class="relative w-full h-screen overflow-hidden">
    ...
    <!-- Текст поверх видео -->
    <div
        class="relative z-20 flex flex-col justify-center items-center h-full text-center text-white px-4 -translate-y-12 sm:-translate-y-20">
...
<section class=" bg-white py-16 px-4 w-full ">
    <div class="max-w-6xl mx-auto ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 cont">
            ...
            <div id="card1" onclick="switchProgram(1)"
                 class="p-6   cursor-pointer transition py-32 shadow-md clip-left active-card h-full ">
                <h3 class="text-lg font-medium mb-4 leading-tight">
                    09.02.07 Информационные системы и программирование. Квалификация: Разработчик веб и мультимедийных
                    приложений
                </h3>
            ...
            <div id="card2" onclick="switchProgram(2)"
                ...
                <h3 class="text-lg font-medium mb-4 leading-tight absolute right-0">
                    09.02.09 Веб-разработка. Квалификация: Разработчик веб приложений
                </h3>
        ...
        <div class="flex  gap-2 mt-4">
            <!-- Левый текст -->
            <div id="descBlock"
                 class="bg-[#DDEBFD] text-black p-8 rounded-lg leading-relaxed text-sm sm:text-base w-[700px] ">
                <!-- Контент будет меняться -->
            </div>

            <!-- Правый текст с иконками -->
            <div id="infoBlock" class="bg-[#DDEBFD] text-black rounded-lg p-10 text-sm sm:text-base w-[350px]">
                <!-- Контент будет меняться -->
            </div>
        </div>
    </div>
...
<section class="bg-white py-16 px-4">
    <div class="max-w-[1300px] mx-auto">
        <h2 class="text-2xl md:text-3xl font-semibold mb-8">О профессии</h2>

        <div class="flex flex-col lg:flex-row justify-between gap-5">
            <!-- Левая колонка -->
            <div class="flex flex-col gap-6 h-full w-full lg:max-w-2xl">
                <!-- Ключевые дисциплины -->
                <div class="bg-[#3F83F8] text-white p-6 rounded-lg">
                    <h3 class="text-lg font-semibold mb-4">Ключевые профессиональные дисциплины:</h3>
                    <ul class="space-y-12 text-sm mt-8">
                        <li class="flex items-center gap-2"><i class='bx bx-check'></i> Проектирование и дизайн информационных систем</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Разработка веб-информационных систем</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Тестирование информационных систем</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Разработка мобильных приложений</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Графический дизайн и мультимедиа</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Оптимизация веб-приложений</li>
                        <li class="flex items-center gap-2"><i class='bx bx-check text-lg'></i> Безопасность веб-приложений</li>
                    </ul>
                </div>
                ...
                <div class="bg-white border border-[#3F83F8] text-[#3F83F8] p-6 rounded-lg">
                    ...
                    <ul class="space-y-6 text-sm mt-6">
                        ...
                        <li class="flex items-center gap-2"><i class='bx bxs-flame'></i> Специалист по сопровождению</li>
                        <li class="flex items-center gap-2"><i class='bx bxs-flame'></i> Контент-менеджер</li>
                    </ul>
                    <div class="flex items-center text-[#3F83F8] text-[12px] mt-5">
            ...
            <!-- Правая колонка -->
            <div class="flex flex-col gap-6 h-full w-full lg:max-w-2xl">
                <div class="bg-white border border-[#3F83F8] text-[#3F83F8] p-6 rounded-lg h-fit">
                    <h3 class="text-lg font-semibold mb-4">Кому подойдёт эта специальность?</h3>
                    <p class="mb-2 text-lg">Если тебе нравится:</p>
                    <ul class="space-y-11 text-sm mt-12">
                        <li class="flex items-start gap-2"><i class='bx bx-heart'></i> Работать с компьютерами и технологиями</li>
                        <li class="flex items-start gap-2"><i class='bx bx-heart'></i> Создавать сайты, приложения или игры</li>
                        <li class="flex items-start gap-2"><i class='bx bx-heart'></i> Разбираться в программировании и дизайне</li>
                        <li class="flex items-start gap-2"><i class='bx bx-heart'></i> Решать логические задачи и придумывать новые идеи</li>
                    </ul>
                ...
                <div class="bg-[#3F83F8] text-white p-6 rounded-lg flex flex-col justify-between">
                    ...
                    <ul class="space-y-5 text-sm mt-7">
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Вёрстке и разработке (HTML, CSS, JS, React/Vue)</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Бэкенду: PHP, Laravel, Python</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Тестированию и поддержке систем</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Проектированию интерфейсов</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> UX/UI-дизайну (Figma)</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Работа с БД (MySQL)</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> CMS (WordPress)</li>
                        <li class="flex items-start gap-2"><i class='bx bx-check'></i> Создание приложений и веб-сайтов</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
                ...
                <div class="flex flex-col items-center text-white text-center">
                    <div class="w-[200px] h-[200px] rounded-full overflow-hidden">
                        <img src="{{ asset('images/user.png') }}" alt="Преподаватель"
                             class="w-full h-full object-cover"/>
                    </div>
                    <p class="text-sm mt-3 font-semibold leading-tight">Иванов <br> Иван Иванович</p>
                    <p class="text-xs mb-2">Председатель цикловой комиссии «Веб-технологии»</p>
    ...
    <div id="teacher1" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-[#3F83F8] text-white rounded-lg max-w-[450px] w-full p-6 relative">
            ...
            <div class="flex items-center gap-4 mb-4">
                <img src="{{ asset('images/user.png') }}" class="w-[70px] h-[70px] rounded-full object-cover"
                     alt="Фото преподавателя">
                <div>
                    <p class="text-sm">Ивано Иван Иванович</p>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <ul class="list-disc ml-5 text-sm space-y-1">
                    <li>Разработка веб-приложений, фронтенд и бэкенд программирование, управление учебными программами в
                        области веб-технологий.
                    </li>
                </ul>
            </div>
        </div>
...
<section class="bg-white py-16 px-4">
    <footer class="bg-white py-10 px-4 shadow-[0_0_20px_0_rgba(63,131,248,0.20)]  rounded-3xl max-w-[1300px] mx-auto">
...
<script>
    const data = {
      ...
      `,
        ...
        <a href="#" class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-white rounded text-sm"><i class='bx bx-download'></i> Скачать ФГОС 09.02.07</a>
      `
        },
        2: {
            desc: `
